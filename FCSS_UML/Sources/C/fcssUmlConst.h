...
#define	FCSS_UML_FULL_NAME_LENGTH										512
#define	FCSS_UML_EMAIL_LENGTH												1024

#define FCSS_UML_IZE_OPTION_NAME										20

#define FCSS_UML_SHORT_OPTIONS											"hN"//"hh:NN:Cai" /*LEMBRAR DESTE MALDITO :*/
#define	FCSS_UML_NUMBER_OF_SHORT_OPTIONS						20
#define FCSS_UML_NUMBER_OF_LONG_OPTIONS							20					

#define EOS 																				'\0'

#define FCSS_UML_SIZE_FILENAME											200

#define FCSS_UML_CONFIGURATION_FILE									"fcss-uml.cfg"
